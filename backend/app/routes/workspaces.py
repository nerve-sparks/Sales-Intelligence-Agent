...
router.post("", response_model=WorkspaceOut)(workspaces_controller.create)
router.get("", response_model=list[WorkspaceOut])(workspaces_controller.list_all)
...
members_router.post("", response_model=MemberOut)(workspaces_controller.add_workspace_member)
members_router.get("", response_model=list[MemberOut])(workspaces_controller.list_workspace_members)
